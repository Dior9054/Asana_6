...
export default function My_Peaple({ del, half, full, check__Half, check__Full }) {
    return (
        <>
                ...
                <div>
                    <div className="flex flex-col gap-[6px]">
                        <div className="w-[max-content] flex items-center pb-[4px] gap-[8px] group" >
                            <h2 className="font-roboto font-[500] text-[20px] leading-[28px] duration-[0.2s] text-[#f5f4f3]">Люди</h2>
                            <CallModal
                                width={190}
                                pos="bottom-right"
                                event={
