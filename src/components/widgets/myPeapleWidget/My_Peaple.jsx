...
export default function My_Peaple() {
    return (
        <div className="w-[100%] h-[410px] shadow-custom border-[1px] border-solid border-[#2a2b2d] bg-[#2a2b2d] rounded-[8px] cursor-pointer relative duration-[0.2s] hover:shadow-custom_hover group/item">
