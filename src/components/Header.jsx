...
import { HeaderBuregrBtn, OwnDate } from './Layout';
...
export default function Header() {
    ...
    const user_color = () => {
        return JSON.parse(localStorage.getItem("user-color"))
    }
        ...
        <div className="bg-[#2e2e30] border-b-[1px] border-b-solid border-b-[#ffffff1c] flex items-center justify-between px-[22px] py-[7px] pr-[10px] w-[100%]">
            <div className="flex items-center justify-start gap-[10px] w-[100%]">
                ...
                <CallModal
                    ...
                    } text="Проект" link={true} path="/new" />
                    <CallItem imgSrc={
                        <svg viewBox="0 0 32 32" width="20" hanging="20">
                        ...
                        <CallModal
                            ...
                            event={
                                <button className="flex items-center justify-center cursor-pointer gap-[3px]">
                                    <div className="w-[28px] h-[28px] rounded-[50%]" style={{ "background": `#${user_color()}` }}>
                                        {mySelf?.username?.slice(0, 2)}
                                    </div>
                            ...
                            <div className="flex bg-[#3d3120] px-[16px] py-[4px] items-center justify-center gap-[3px]">
                                <p className='font-roboto text-[14px] leading-[30px] text-[#f1bd6c]'>26 days left in trial.</p>
                                <Link className='text-[#a2a0a2] font-roboto text-[14px] cursor-pointer underline hover:text-[#c9c9c9]'>Подробнее</Link>
                            </div>
                            <div className="flex flex-col items-center px-[12px] py-[16px]">
                                <div className="w-[48px] h-[48px] rounded-[50%] flex items-center justify-center mb-[8px]" style={{ "background": `#${user_color()}` }}>
                                    <p className='font-[400] text-[24px]'>{mySelf?.username?.slice(0, 2)}</p>
                                </div>
                                <h1 className='font-roboto text-[16px] leading-[20px] font-500 text-center text-[#f5f4f3]'>My workspace</h1>
                                <h2 className='font-roboto text-[12px] leading-[18px] font-400 text-center text-[#a2a0a2]'>{mySelf?.email}</h2>
                            </div>
                            <CallItem imgSrc={
                                <svg viewBox="0 0 32 32" width="20" height="20">
